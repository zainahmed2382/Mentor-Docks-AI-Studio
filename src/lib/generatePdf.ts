...
export async function downloadPdfReport(scan: WebsiteScan): Promise<void> {
  ...
  // Create an off-screen, completely isolated iframe to prevent any parent document reflow or layout shifts
...
<body>
  ...
  try {
    ...
    const rootElement = iframeDoc.querySelector(".pdf-root") as HTMLElement;
